...
void loadValuesIntoMenu() {
  slot_1_price.set_value((prices[0]*1.0)/100.0);
  slot_2_price.set_value((prices[1]*1.0)/100.0);
  slot_3_price.set_value((prices[2]*1.0)/100.0);
  slot_4_price.set_value((prices[3]*1.0)/100.0);
  slot_5_price.set_value((prices[4]*1.0)/100.0);
  slot_6_price.set_value((prices[5]*1.0)/100.0);
  slot_7_price.set_value((prices[6]*1.0)/100.0);
  slot_8_price.set_value((prices[7]*1.0)/100.0);
  slot_9_price.set_value((prices[8]*1.0)/100.0);
  slot_10_price.set_value((prices[9]*1.0)/100.0);
  slot_11_price.set_value(( prices[10]*1.0)/100.0);
  slot_12_price.set_value(( prices[11]*1.0)/100.0);
  slot_13_price.set_value(( prices[12]*1.0)/100.0);
  slot_14_price.set_value(( prices[13]*1.0)/100.0);
  slot_15_price.set_value(( prices[14]*1.0)/100.0);
  slot_16_price.set_value(( prices[15]*1.0)/100.0);
  slot_17_price.set_value(( prices[16]*1.0)/100.0);
  ...
  coin_1_value.set_value((coinValues[0]*1.0)/100.0);
  coin_2_value.set_value((coinValues[1]*1.0)/100.0);
  coin_3_value.set_value((coinValues[2]*1.0)/100.0);
  coin_4_value.set_value((coinValues[3]*1.0)/100.0);
  coin_5_value.set_value((coinValues[4]*1.0)/100.0);
  coin_6_value.set_value((coinValues[5]*1.0)/100.0);
}
